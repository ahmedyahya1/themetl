...
if(!class_exists('Apress_Featured_Products_Module')) {
	class Apress_Featured_Products_Module {
		function __construct() {
			add_action( 'init', array( &$this, 'apress_featured_products_init' ) );			
			add_shortcode('apress_featured_products', array( &$this, 'apress_featured_products' ) );
		}
		
		function apress_featured_products_init() {
			...
			if ( function_exists( 'vc_map' ) ) {
				vc_map( array(
					"name"			=> __("Apress Featured Products", 'apcore'),
					"base"			=> "apress_featured_products",
					"class"			=> "",
					//"weight"		=> 23,
					"category"		=> __( "WooCommerce", "apcore"),
					"description"	=> __( "Featured Products", "apcore"),
		...
		function apress_featured_products( $atts ){		
			ob_start();
...
<?php 
	...
	$Apress_Featured_Products_Module = new Apress_Featured_Products_Module;
}
