    ...
    class ReduxFramework_color_alpha extends ReduxFramework {
        ...
        public function render() {
            ...
            if ( ! isset( $this->field['transparent'] ) || $this->field['transparent'] !== false ) {
                ...
                echo '<label for="' . $this->field['id'] . '-transparency" class="color-transparency-check"><input type="checkbox" class="checkbox color-transparency ' . $this->field['class'] . '" id="' . $this->field['id'] . '-transparency" data-id="' . $this->field['id'] . '-color" value="1"' . $tChecked . '> ' . __( 'Transparent', 'apcore' ) . '</label>';
            }
			echo '</div>';
        }
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                trailingslashit( APRESS_EXTENSIONS_PLUGIN_URL ) . '/redux_extensions/extensions/color_alpha/color_alpha/field_color_alpha' . Redux_Functions::isMin() . '.js',
