...
// Header layout 
if( !function_exists('apress_theme_header') ){
	function apress_theme_header() {
...
if( !function_exists('apress_theme_mobile_woocommerce') ){
	function apress_theme_mobile_woocommerce() {
		global $woocommerce;				
 ...
 */
if( ! function_exists( 'apress_theme_get_related_posts' ) ) {
	function apress_theme_get_related_posts( $post_id, $number_posts = 4 ) {
		$query = new WP_Query();
		$args = '';
		if( $number_posts == 0 ) {
			return $query;
 ...
 */
if( ! function_exists( 'apress_theme_get_related_portfolio' ) ) {
	function apress_theme_get_related_portfolio( $post_id, $number_posts = 4 ) {
		$query = new WP_Query();
 ...
 */
if( ! function_exists( 'apress_theme_get_related_team' ) ) {
	function apress_theme_get_related_team( $post_id, $number_posts = 4 ) {
		$query = new WP_Query();
...
function apress_theme_slider_name( $name ) {
	$type = '';
...
function apress_theme_get_slider_type( $post_id ) {
	$get_slider_type = get_post_meta($post_id, 'zt_page_slider_type', true);
	return $get_slider_type;
}

function apress_theme_get_slider( $post_id, $type ) {
	$type = apress_theme_slider_name( $type );
	if( $type ) {
...
function apress_theme_slider( $post_id ) {
	$slider_type = apress_theme_get_slider_type( $post_id );
	$slider = apress_theme_get_slider( $post_id, $slider_type );

	if( $slider ) {
		$slider_name = apress_theme_slider_name( $slider_type );
		
		$function = 'apress_theme_' . $slider_name;

		$function( $slider );
	}
}

function apress_theme_revslider( $name ) {
 ...
 * Title Bar
 */
if( ! function_exists( 'apress_theme_current_page_title_bar' ) ) {
	function apress_theme_current_page_title_bar( $post_id ) {
	global $apress_data;
		...
		<div class="pagetitle_parallax_section <?php echo $apress_data["page_titlebar_style"];?>">
		  <div class="pagetitle_parallax" data-parallax="<?php if($titlebar_parallax_bg == 'No'){echo '';}else if($titlebar_parallax_bg == 'Yes'){echo esc_url($image_url);}else{ if($page_title_bg_parallax == 'on'){echo esc_url($image_url); } } ?>" style="background:<?php echo esc_attr($bg_color);?> url(<?php echo esc_url($image_url);?>);">
              ...
              <div class="pagetitle_parallax_content">
				...
				<?php if (function_exists('apress_theme_breadcrumbs')) apress_theme_breadcrumbs(); ?>
				<?php endif; ?>
			  </div>
              </div>
			</div>
...
if( ! function_exists( 'apress_theme_archive_thumbnail_video' ) ) {
	function apress_theme_archive_thumbnail_video() {
		global $apress_data, $post;
		...
		if( has_post_thumbnail() || $post_video ){
			if (!$format_quote && !$format_audio){
				...
				if( apress_theme_number_of_featured_images() > 0 && class_exists( 'kdMultipleFeaturedImages' )){
...
// Show Number of featured images
if( ! function_exists( 'apress_theme_catportfolio_thumbnail_video' ) ) {
	function apress_theme_catportfolio_thumbnail_video() {
		global $apress_data, $post;
...
// Show Number of featured images
if( ! function_exists( 'apress_theme_single_layout_thumbnail_video' ) ) {
	function apress_theme_single_layout_thumbnail_video() {
		global $apress_data, $post;
		if(!is_object($post)) return;
...
// Show Number of featured images
if( ! function_exists( 'apress_theme_number_of_featured_images' ) ) {
	function apress_theme_number_of_featured_images() {
		global $apress_data, $post;
		if(!is_object($post)) return;
		$number_of_images = 0;
...
if ( ! function_exists( 'apress_theme_paging_nav' ) ) {
	function apress_theme_paging_nav() {
		global $wp_query;
...
if ( ! function_exists( 'apress_theme_single_page_nav' ) ) {
	//Display navigation to next/previous post when applicable.
	function apress_theme_single_page_nav() {
...
if ( ! function_exists( 'apress_theme_entry_date' ) ) {
//Print HTML with date information for current post.
	function apress_theme_entry_date( $echo = true ) {
...
if ( ! function_exists( 'apress_theme_entry_meta' ) ) {
	//Print HTML with date information for current post.
	function apress_theme_entry_meta( $post_meta,$format_quote, $post_title_alignment,$post_title_position) {
		global $apress_data; 
...
if ( ! function_exists( 'apress_theme_tags' ) ) {
	function apress_theme_tags() {
...
// Blog Pagination
if ( !function_exists( 'apress_theme_pagination' ) ) {
	function apress_theme_pagination() {
...
if ( !function_exists( 'apress_theme_portfolio_pagination' ) ) {
	function apress_theme_portfolio_pagination($pages = '', $range = 2){ 
...
// Topbar Section
if ( !function_exists( 'apress_theme_topbar_section' ) ) {
	function apress_theme_topbar_section($key) {
	...
	switch($key) {
			...
			case 'multilingual':
				...
				if($apress_data["multilingual_code"]){ 
					echo '<li class="zolo_multilingual_code">'.apress_theme_execute_text_php($apress_data["multilingual_code"]).'</li>';		
				}	
			break;  
			...
			case 'text1':
				...
				if($apress_data["header_html_text1"]){ 
					echo '<li class="header_htmltext header_html_text1">'.apress_theme_execute_text_php($apress_data["header_html_text1"]).'</li>';		
				}
			break;
			...
			case 'text2':
				...
				if($apress_data["header_html_text2"]){ 
					echo '<li class="header_htmltext header_html_text2">'.apress_theme_execute_text_php($apress_data["header_html_text2"]).'</li>';		
				}
			break;
			...
			case 'text3':
				...
				if($apress_data["header_html_text3"]){ 
					echo '<li class="header_htmltext header_html_text3">'.apress_theme_execute_text_php($apress_data["header_html_text3"]).'</li>';		
				}
			break;
...
// Header Section
if ( !function_exists( 'apress_theme_header_section' ) ) {
	function apress_theme_header_section($key) {
...
if ( !function_exists( 'apress_theme_vertical_header_section' ) ) {
	function apress_theme_vertical_header_section($key) {	   
	global $apress_data, $woocommerce;
...
if ( !function_exists( 'apress_theme_preset_custom_top_header_main_menu' ) ) {
		function apress_theme_preset_custom_top_header_main_menu(){		
		global $apress_data;
...
// Expanded Search
if ( !function_exists( 'apress_theme_expanded_search' ) ) {
	function apress_theme_expanded_search ($layout ){
		global $apress_data;
...
// Header Logo
if ( !function_exists( 'apress_theme_header_logo' ) ) {
	function apress_theme_header_logo(){
		global $apress_data , $post;	
		if(!is_object($post)) return;
...
if ( !function_exists( 'apress_theme_mobile_menu' ) ) {
	function apress_theme_mobile_menu(){
	global $apress_data;	
...
// Social Sharing
if ( !function_exists( 'apress_theme_social_sharing' ) ) {
	function apress_theme_social_sharing(){
		global $post, $apress_data;
...
// Comment	
if ( !function_exists( 'apress_theme_comment' ) ) {	
	function apress_theme_comment( $comment, $args, $depth ) {
		$add_below = ''; ?>
...
// Post Sidebar Class
if ( !function_exists( 'apress_theme_sidebar_and_class' ) ) {	
	function apress_theme_sidebar_and_class($sidebar_class, $sidebar, $post_type){			
		global $post, $apress_data;		
		if(!is_object($post)) return;
...
// Page Sidebar Class
if ( !function_exists( 'apress_theme_page_sidebar_class' ) ) {
	function apress_theme_page_sidebar_class($sidebar_class, $sidebar){
		global $apress_data, $post;
		if(!is_object($post)) return;
...
// Page Sidebar Class
if ( !function_exists( 'apress_theme_archive_sidebar_class' ) ) {
	function apress_theme_archive_sidebar_class($sidebar_class, $sidebar){
		global $apress_data, $post;
...
// Page Sidebar Class
if ( !function_exists( 'apress_theme_search_sidebar_class' ) ) {
	function apress_theme_search_sidebar_class($sidebar_class, $sidebar){
		global $apress_data, $post;
...
// Apress Author Info
if ( !function_exists( 'apress_theme_author_info' ) ) {
function apress_theme_author_info(){
	global $post, $apress_data;
	if(!is_object($post)) return;
...
if ( !function_exists( 'apress_theme_portfolio_details' ) ) {
	function apress_theme_portfolio_details(){
	global $post, $apress_data;
	if(!is_object($post)) return;
...
*****************************************************/
if (!function_exists('apress_theme_photoswipe_wrapper')) {
	
	function apress_theme_photoswipe_wrapper( $atts ) { 
	global $apress_data;
...
add_action('wp_footer','apress_theme_photoswipe_wrapper');
}

/*****************************************************
  Apress Theme Option PHP Shortcode
*****************************************************/
function apress_theme_execute_text_php($html){
