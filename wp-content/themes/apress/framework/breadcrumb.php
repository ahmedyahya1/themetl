 ...
 *
*/
class apress_theme_bread_crumb{
	public function apress_theme_breadcrumbs( $args = '' ) {
...
$apress_theme_bread_crumb = new apress_theme_bread_crumb();

if ( ! function_exists( 'apress_theme_breadcrumbs' ) ) {
function apress_theme_breadcrumbs( $args = '' ) {
	global $apress_theme_bread_crumb;
	return $apress_theme_bread_crumb->apress_theme_breadcrumbs( $args );
}
}
/* Breadcumb End */
