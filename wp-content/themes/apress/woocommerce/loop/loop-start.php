...
?>
<ul class="products columns-<?php echo esc_attr( wc_get_loop_prop( 'columns' ) ); ?> <?php echo esc_attr($woocommerce_product_style.' '.$woo_layout.' woo_badges_shape_'.$woo_badges_shape);?>">
