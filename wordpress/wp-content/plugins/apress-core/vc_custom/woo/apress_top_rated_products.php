...
if(!class_exists('Apress_Top_Rated_Products_Module')) {
	class Apress_Top_Rated_Products_Module {
		function __construct() {
			add_action( 'init', array( &$this, 'apress_top_rated_products_init' ) );			
			add_shortcode('apress_top_rated_products', array( &$this, 'apress_top_rated_products' ) );
		}
		
		function apress_top_rated_products_init() {
			...
			if ( function_exists( 'vc_map' ) ) {
				vc_map( array(
					"name"			=> __("Apress Top Rated Products", 'apcore'),
					"base"			=> "apress_top_rated_products",
					"class"			=> "",
					//"weight"		=> 23,
					"category"		=> __( "WooCommerce", "apcore"),
					"description"	=> __( "Top Rated Products", "apcore"),
		...
		function apress_top_rated_products( $atts ){		
			ob_start();
...
<?php 
	...
	$Apress_Top_Rated_Products_Module = new Apress_Top_Rated_Products_Module;
}
