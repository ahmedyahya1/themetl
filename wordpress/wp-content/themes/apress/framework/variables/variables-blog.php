...
$blog_sidebar_position = isset($apress_data["blogposts_sidebar_position"]) ? $apress_data["blogposts_sidebar_position"] : 'left';
$blog_layout = isset($apress_data["blog_layout"]) ? $apress_data["blog_layout"] : 'masonry';
...
if($page_sidebar_position == 'default' || $page_sidebar_position == 'none' || $page_sidebar_position == ''){
	...
	if($blog_sidebar_position == 'left'){
		...
		if($blog_layout == 'small'){
			...
			$blog_layout_thumb = 'apress_thumb_blog_medium';
			...
			$blog_layout_thumb = 'apress_thumb_blog_large';
